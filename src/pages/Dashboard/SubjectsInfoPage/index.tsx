...
@observer
export default class SubjectsInfoPage extends React.Component<IProps> {
	public componentDidMount = async () => {
		const { classId } = this.props.match.params;

		await this.props.schoolClassesStore.clear();
		...
		await this.props.schoolClassesStore.getCommentariesForSchoolClass();
	}
		...
		return (
			<div className="subjectInfoPage">
				<div className="subjectInfoPageContainer">
					{schoolClassesStore.loading && <LinearProgress />}
					...
					{selectedSchoolClassProfessores.length > 0 &&
						<>
							<Typography variant="h6">
					...
					<div className="subjectInfoPageContainerCommentariesContainer">
						{schoolClassesStore.commentaries.length > 0 &&
							<>
								<Typography variant="h6">
